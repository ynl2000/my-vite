...
function $e(e, t, n) {
  ...
  return o > -1 && o === r && B(t.matched[o], n.matched[r]) && Ze(t.params, n.params) && e(t.query) === e(n.query) && t.hash === n.hash;
}
function B(e, t) {
...
function gn(e, t) {
  ...
  function c(s, a, u) {
    ...
    for (const S of N) {
      const { path: x } = S;
      if (a && x[0] !== "/") {
        const U = a.record.path, V = U[U.length - 1] === "/" ? "" : "/";
...
function He(e) {
  const t = Z(Re), n = Z(ct), o = D(() => t.resolve(Y(e.to))), r = D(() => {
    ...
    if (!s || !a.length)
      return -1;
    const u = a.findIndex(B.bind(null, s));
    if (u > -1)
      return u;
    const p = Ke(l[d - 2]);
    return d > 1 && Ke(s) === p && a[a.length - 1].path !== p ? a.findIndex(B.bind(null, l[d - 2])) : u;
...
const qe = (e, t, n) => e != null ? e : t != null ? t : n, qn = /* @__PURE__ */ Qe({
  ...
  setup(e, { attrs: t, slots: n }) {
    ...
    return Ye(() => [l.value, h.value, e.name], ([d, s, a], [u, p, y]) => {
      s && (s.instances[a] = d, p && p !== s && d && d === u && (s.leaveGuards.size || (s.leaveGuards = p.leaveGuards), s.updateGuards.size || (s.updateGuards = p.updateGuards))), d && s && (!p || !B(s, p) || !u) && (s.enterCallbacks[a] || []).forEach((C) => C(d));
    }, { flush: "post" }), () => {
...
function pt(e, t) {
  ...
  e.__vd_exactActive = e.__vd_active = n, n || (e.__vd_active = t.matched.some((o) => B(o, e.record))), e.children.forEach((o) => pt(o, t));
}
function mt(e) {
...
function oo(e) {
  const t = gn(e.routes, e), n = e.parseQuery || Tn, o = e.stringifyQuery || Ue, r = e.history;
...
function ro(e, t) {
  ...
  for (let f = 0; f < c; f++) {
    const h = t.matched[f];
    h && (e.matched.find((d) => B(d, h)) ? o.push(h) : n.push(h));
    const l = e.matched[f];
    l && (t.matched.find((d) => B(d, l)) || r.push(l));
  }
  return [n, o, r];
}
const so = [
  {
    path: "/",
    name: "\uBE48\uD0EC\uD50C\uB9BF",
    component: () => import("./Template.08700f3e.js"),
    children: [
      {
        path: "/",
        name: "\uBA54\uC778\uD398\uC774\uC9C0",
        component: () => import("./index.243b63e8.js")
      },
      {
        path: "/about",
        name: "aboutus",
        component: () => import("./about.e91250bb.js")
      },
      {
        path: "/skill",
        name: "skill",
        component: () => import("./skill.3a8281c3.js")
      },
      {
        path: "/history",
        name: "history",
        component: () => import("./history.bc8a9936.js")
      },
      {
        path: "/contact",
        name: "contact",
        component: () => import("./contact.85befb1e.js")
      }
    ]
  }
], io = oo({
